...
# - GPT-large embedding table: `graph_gpt.parquet`
# - GPT-small embedding table: `graph_gpt_small.parquet`
...
# 2. `graph_minilm`: CT/node features plus MiniLM text embeddings reduced by PCA to 32 dimensions.
# 3. `graph_gpt`: CT/node features plus GPT-large text embeddings reduced by PCA to 32 dimensions.
# 4. `graph_gpt_small`: CT/node features plus GPT-small text embeddings reduced by PCA to 32 dimensions.
#
...
GRAPH_GPT_SMALL_FILE = PROJECT_ROOT / 'data/processed/model_df/graph_gpt_small.parquet'
...
# 1. graph_baseline uses graph_df_minilm.parquet without text embeddings
# 2. graph_minilm uses MiniLM embeddings from graph_df_minilm.parquet
# 3. graph_gpt uses GPT-large embeddings from graph_gpt.parquet
# 4. graph_gpt_small uses GPT-small embeddings from graph_gpt_small.parquet
FEATURE_SET_MODES = [
    'graph_baseline',
    'graph_minilm',
    'graph_gpt',
